...
const Index: React.FC = () => {
  ...
  return (
    <div tw="flex flex-col w-full h-screen">
      <div tw="py-4 text-white  bg-red-500 sticky top-0">
        <h1 tw="text-center text-3xl font-bold">Masai Discussion Forum</h1>
      </div>
      <div tw="flex flex-col flex-1 bg-gray-200">
        <div tw="flex-1 p-4 font-mono">
          {chat.length ? (
            ...
            <div tw="text-sm text-center text-gray-400 py-6">No Discussion</div>
          )}
        </div>
        <div tw="bg-gray-400 p-4 h-20 sticky bottom-0">
          <div tw="flex flex-row flex-1 h-full divide-gray-200 divide-x">
            ...
            <div tw="flex flex-col justify-center items-stretch pl-2">
              <button
                tw="bg-red-500 rounded shadow text-sm text-white h-full px-2"
                onClick={sendMessage}
                disabled={!connected}
              >
                SEND
